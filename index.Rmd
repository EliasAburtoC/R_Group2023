...
CNPP_data|>
  ...
  labs(
    title = "PERÚ: CONSUMO ANTES DE INGRESAR AL ESTABLECIMIENTO PENITENCIARIO",
...
CNPP_data |>
  ...
  scale_fill_brewer(palette="Set1") +
  labs(
    title = "PERÚ: ¿ALGÚN MIEMBRO DE LA FAMILIA DEL REO PENITENCIARIO ESTUVO PRESO EN UN ESTABLECIMIENTO PENITENCIARIO ALGUNA VEZ?",
    subtitle = "(Frecuencia, porcentaje)")
```
...
CNPP_data |>
  ...
  scale_fill_brewer(palette="Set1") +
  labs(
    title = "PERÚ: ANTES DE QUE EL REO PENITENCIARIO CUMPLA 18 AÑOS, ¿ALGUNO DE SUS MEJORES AMIGOS COMETÍAN DELITOS?",
    subtitle = "(Frecuencia, porcentaje)")
```

Como puede observarse, el 65% de los reos señala que, antes de cumplir los 18 años de edad, no tuvieronconsuumo
algún mejor amigo que cometía delitoso; mientras que un 34% señala que sí lo tuvo.
...
CNPP_data |>
  ...
  scale_fill_brewer(palette = "Set1") +
  labs(
    title = "PERÚ: POBLACIÓN PENITENCIARIA QUE PADECE DE ALGUNA ENFERMEDAD",
    subtitle = "(Frecuencia)",
    x = "Enfermedades",
    y = "Frecuencia")+
  theme(axis.text.x = element_blank())
...
##### P201_DD. 201. DEPARTAMENTO EN EL QUE OCURRIO EL DELITO"**
...
table(CNPP_data$P403_1, CNPP_data$DELITO_GENERICO)
