...
1. Sobre los antecedentes y aspectos sociodemográficos (antes) se identificaron las siguientes conclusiones:
...
- El 43.3% de los internos han participado en algún Programa de Intervención Multidisciplinario.
Lima es la primera ciudad de Origen de los reos actualmente, llegando aproximandamente a 18mil personas de sexo masculino, y unos 1800 personas de sexo femenino, seguido por las ciudades de Huanuco, La Libertad y Piura.
...
- La mayoría de la población penitenciaria considera trabajar como la principal actividad a realizar (92.9%), mientras que estudiar (13.4%), viajar (4.9%), retornar a su país (1.4%) u otra actividad (1.9%) ocupan menos interés. En ese contexto, el interés por el trabajo como principal actividad se posiciona como un factor clave que podría influenciar en el interno para desistir de cometer actos delictivos en el futuro. Sin embargo, es importante mencionar que sólo el 48.1% participa en labores reconocidas por el INPE; asimismo, el 25.7% participa de los talleres penitenciarios y el 53.8% de ellos participa con la finalidad de aprender algún oficio.
